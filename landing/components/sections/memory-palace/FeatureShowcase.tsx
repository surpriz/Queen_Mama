...
const featureKeys = [
  { key: "aiExtraction", color: "success" },
  { key: "sync", color: "accent" },
  { key: "notes", color: "accent" },
  { key: "briefings", color: "success" },
  { key: "import", color: "auto-answer" },
  { key: "intelligence", color: "accent" },
] as const;
