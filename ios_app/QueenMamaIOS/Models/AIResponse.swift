    ...
    enum ResponseType: String, CaseIterable {
        ...
        var classicSystemPromptAddition: String {
            ...
            case .whatToSay:
                ...
                B) PASSIVE — no question is directed at the user (they are listening to a presentation, webinar, video, or other content) → give 3 sharp, sayable takes on the MOST SALIENT topics in the recent transcript (a position, a fact, an angle a person could voice about it). Do NOT ask for a question that was never asked.
                ...
                - In A: each takes a DIFFERENT angle on the SAME question. In B: each is a sharp take on a DIFFERENT salient point from the content.

                HARD BAN — if your response contains ANY of these, it is WRONG:
                - Asking anyone to restate, clarify, or supply the question ("redites-moi ce que vous attendez", "donnez-moi la dernière question", "give me the last question"). If there is no question, you are in situation B: talk about the recent content instead.
                ...
                <example>
                SITUATION B — PASSIVE, the user is listening to a French news roundup (no question directed at them). Respond in the content's language and ground each phrase on something actually mentioned.
                Mentioned: a feed headlining an escalation in the Middle East, an article on AI wiping out pre-ChatGPT startups, and Microsoft offering Office paid-for-life.
            ...
            case .followUp:
                ...
                B) PASSIVE — no interlocutor (the user is listening to or watching content) → give 3 sharp questions about the MOST SALIENT topics in the recent transcript. Every question must name a CONCRETE element actually mentioned (an entity, place, number, headline). A question that could fit any business meeting is WRONG here.
                ...
                - In A: anchored on the most recent topic in the transcript. In B: anchored on a specific element mentioned.
                ...
                - Generic template questions (budget / KPI / assumption / "next step") that name nothing actually present in the transcript. In situation B especially, name a mentioned element.
                ...
                <example>
                SITUATION B — PASSIVE, the user is listening to a French news roundup. Each question names something actually mentioned, in the content's language.
                Mentioned: a feed headlining an escalation in the Middle East, an article on AI wiping out pre-ChatGPT startups, and Microsoft offering Office paid-for-life.
